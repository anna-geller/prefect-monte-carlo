...
def extract_and_load_raw_data(
    ...
    for id_ in range(1, 1001):
        single_row = dict(
            id=id_, first_name=names.get_first_name(), last_name=names.get_last_name()
        )
    ...
    job_config = bigquery.LoadJobConfig(
        ...
        schema=[
            ...
            bigquery.SchemaField(
                name="first_name", field_type="STRING", mode="REQUIRED"
            ),
            bigquery.SchemaField(
                name="last_name", field_type="STRING", mode="REQUIRED"
            ),
        ],
    )
...
with Flow("dwh_raw_customers") as flow:
    ...
    bq_tbl = Parameter("bq_tbl", default="raw_customers")
    ...
    monte_carlo(
        ...
        lineage_tags=[
            {"propertyName": "data_owner", "propertyValue": "marketing"},
            {"propertyName": "data_source_system", "propertyValue": "CRM"},
        ],
